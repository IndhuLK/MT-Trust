...
const TrustMember = () => {
  return (
    <div className="flex bg-blue-50 px-15 py-10 gap-6 font-family">
        ...
        <div className="flex items-start gap-16">
          ...
          <div className="flex-1 h-[40vh] flex flex-col justify-between">
            <div>
              ...
              <h2 className="text-lg font-semibold text-gray-600 mb-2 mt-4">B.Sc (Agriculture) PG DIP.RD</h2>
              <h2 className="text-lg font-semibold text-gray-600 mb-2 mt-4">President</h2>
        ...
        <div className="flex items-start gap-16">
          ...
          <div className="flex-1 h-[30vh] flex flex-col justify-between mt-0">
            <div>
              ...
              <h2 className="text-lg font-semibold mb-2 mt-4 text-gray-600">
                Program officer
              </h2>
            </div>
