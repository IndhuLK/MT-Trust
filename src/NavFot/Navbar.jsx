    ...
    <>
      ...
      MTSSDS
        ...
        <div className="hidden md:flex">
          <button className="bg-yellow-400 text-black font-semibold px-6 py-2 rounded-md shadow-md hover:scale-105 transition">
            Contact Us
          </button>
        </div>
      ...
      {openMenu && (
        <div className="md:hidden fixed inset-0 bg-[#06457A] z-50 flex flex-col justify-center items-center px-4">
          ...
          {/* Contact Button */}
          <button className="absolute bottom-10 bg-yellow-400 text-black px-6 py-2 rounded-md w-[30%] font-semibold">
            Contact Us
          </button>
        </div>
      )}
